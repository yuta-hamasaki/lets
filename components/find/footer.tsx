...
export const Footer = ({ activePage, onNavigate }:any) => {
    ...
    return (
        <footer className=" bottom-0 left-0 right-0 bg-white h-20 px-2 flex justify-around items-center z-40 rounded-t-2xl shadow-[0_-4px_12px_rgba(0,0,0,0.08)] max-w-[320px] mx-auto w-full">
            {navItems.map(item => (
